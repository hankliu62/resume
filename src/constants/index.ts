...
export const Projects = [
  ...
  },
  {
    ...
    profile:
      "内容生产后台管理系统是特赞基地，是内容生产的数字化管理平台，包含数据面板，CRM/业务管理，数字资源，业务/商城运营，Muse创新项目管理等模块，具有从销售线索，到销售机会，企业项目，创意方报价，再到业务签单，业务交互的完整的销售过程，同时还管理创意方和案例的数字资源，以及存储创新产品配置信息。",
    duties: [
      ...
      "在项目迭代的间隙中，还会辅助一些创新项目的构建和开发，比如公司的muselink，musetransfer和museart等创新项目。",
    ],
    summary:
  ...
  },
  {
    ...
    profile:
      "八爪鱼AI是国内专业的内容服务平台，服务于内容方，帮助合作方解决粉丝运营的难题。",
    duties: [
      "独立开发，从构建、开发到维护都是独自一人实现;",
